        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex-grow flex flex-col">
          <div className="space-y-6 flex-grow">
            ...
            <div>
              ...
              <div className="relative h-2 w-full mt-4">
                  <div className="absolute h-1 w-full bg-slate-700 rounded-full top-1/2 -translate-y-1/2" />
                  <div className="absolute h-1 bg-cyan-400 rounded-full top-1/2 -translate-y-1/2" style={{ left: `${minPricePercent}%`, width: `${maxPricePercent - minPricePercent}%` }} />
                  <input
                      type="range"
                      min="0"
                      max={MAX_PRICE}
                      ...
                      className="absolute w-full h-1 top-1/2 -translate-y-1/2 appearance-none bg-transparent pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:cursor-pointer"
                  />
                  <input
                      type="range"
                      min="0"
